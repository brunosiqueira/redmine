class AddPreRequirementConclusionRule < ActiveRecord::Migration
  def self.up
    ...
    rule.solutions.create! :name=>"SolutionClosePreRequirement",:message=>"Finalizar pré-requisito"
    rule.solutions.create! :name=>"SolutionRemovePreRequirement",:message=>"Desassociar pré-requisito"
  end
